...
export const coupons: Coupon[] = [
  ...
  },
  {
    ...
    day: 19,
    title: 'Wieczór Tańca',
    description: 'Prywatna lekcja tańca w domu + Twoja ulubiona muzyka OCZYWIŚCIE KIEDYŚ W ŻYCIU PATRZ DO KIEDY!',
    validUntil: '28.02.2029',
    emoji: '💃',
    color: categoryColors[CouponCategory.CREATIVE],
    category: CouponCategory.CREATIVE,
    difficulty: 'medium',
    tags: ['taniec', 'muzyka', 'zabawa'],
    redeemInstructions: 'Nie martw się o umiejętności - będzie zabawnie!',
  },
  {
    id: 20,
    day: 20,
  ...
  },
  {
    ...
    description: 'Romantyczny wieczór z winem!',
    validUntil: '28.02.2026',
    emoji: '🍷',
    color: categoryColors[CouponCategory.ROMANTIC],
    category: CouponCategory.ROMANTIC,
    difficulty: 'medium',
    tags: ['wino', 'degustacja', 'elegancja'],
    redeemInstructions: 'Możesz wybrać rodzaj wina (czerwone, białe, różowe)!',
  },
